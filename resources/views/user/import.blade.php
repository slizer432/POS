        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password_default" id="password_default" class="form-control" required>
                    <small class="text-muted">Password ini akan digunakan untuk semua user yang diimport</small>
                    <small id="error-password_default" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
